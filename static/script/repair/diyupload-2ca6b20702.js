    ...
    function createBox($fileInput, file, webUploader) {
        ...
        var li = '<li id="fileBox_' + file_id + '" class="diyUploadHover"> \
					<div class="viewThumb">\
                        ...
                        <div class="diySuccess"> \
                            <div class="diyProgress">上传成功</div> \
					    </div> \
					    <p class="diyControl2"><span class="diyCancel2"><i></i></span></p>\
					</div> \
				</li>';
        ...
        *2017-12-25
        */
        var $diyCancel = $fileBox.find('.diyCancel2').one('click', function () {
            //找到图片对应位置的index，进行删除上传图片返回的id
            let $index = $(this).parents('.diyUploadHover').index();
            resultsMedia.splice($index, 1);
